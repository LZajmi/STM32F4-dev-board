...
//1148872/1240948/2.50/2/4/Inductor
...
(library Library_1
	...
	(patternDef "XFL4012" (originalName "XFL4012")
		...
		(layerContents (layerNumRef 18)
			(arc (pt -2.365, 0.089) (radius 0.043) (startAngle 0.0) (sweepAngle 0.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.365, 0.089) (radius 0.043) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
	)
	(symbolDef "XFL4015-471MEC" (originalName "XFL4015-471MEC")
	...
	(compDef "XFL4015-471MEC" (originalName "XFL4015-471MEC") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "XFL4015-471MEC"))
		(attachedPattern (patternNum 1) (patternName "XFL4012")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "994-XFL4015-471MEC")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Coilcraft/XFL4015-471MEC?qs=zCSbvcPd3pYzCOJSVbeMnw%3D%3D")
		(attr "Manufacturer_Name" "COILCRAFT")
		(attr "Manufacturer_Part_Number" "XFL4015-471MEC")
		(attr "Description" "Fixed Inductors 0.47uH 20% 11.2A 8.36mOhms AEC-Q200")
		(attr "<Hyperlink>" "https://www.coilcraft.com/pdfs/xfl4015.pdf")
		(attr "<STEP Filename>" "XFL4015-471MEC.stp")
